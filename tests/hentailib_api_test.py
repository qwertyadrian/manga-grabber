...
TITLES = [
    "234290--couple-under-the-rain",
    "231255--anything-in-the-name-of-love",
]
...
async def chapters(request):
    ...
    title = request.param
    manga_url = f"https://hentailib.me/ru/{title}/"
    async with mangalib.HentaiLib(manga_url, token=TOKEN) as manga:
